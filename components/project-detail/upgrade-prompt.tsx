  ...
  return (
    ...
    >
      <div className="text-center p-8 md:p-12">
        ...
        {/* Feature List */}
        <div className="bg-linear-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 md:p-8 mb-8 text-left">
          <div className="flex items-start gap-3 mb-4">
            {minPlan === "ultra" ? (
              <Crown className="h-6 w-6 text-emerald-600 mt-0.5 shrink-0" />
            ) : (
              <Sparkles className="h-6 w-6 text-emerald-600 mt-0.5 shrink-0" />
            )}
